...
class LoaderManager {
    ...
    init() {
        ...
        // Use existing global loader if available
        this.pageLoader = document.getElementById('globalPageLoader');
    ...
    createLoaderElements() {
        // Create main page loader only if it doesn't exist
        if (!this.pageLoader) {
            this.pageLoader = document.createElement('div');
            this.pageLoader.className = 'page-loader';
            this.pageLoader.id = 'globalPageLoader';
